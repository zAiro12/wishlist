...
function getLoginUrl(): string {
  ...
  const withTrailingSlash = normalizedBaseUrl.endsWith('/') ? normalizedBaseUrl : `${normalizedBaseUrl}/`;
  return new URL('login', `${window.location.origin}${withTrailingSlash}`).toString();
}
